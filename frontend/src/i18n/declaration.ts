...
export enum I18nKey {
  ...
  PROJECT_MANAGEMENT$JIRA_DC_PAUSE_BUTTON_LABEL = "PROJECT_MANAGEMENT$JIRA_DC_PAUSE_BUTTON_LABEL",
  PROJECT_MANAGEMENT$JIRA_DC_RESUME_BUTTON_LABEL = "PROJECT_MANAGEMENT$JIRA_DC_RESUME_BUTTON_LABEL",
